...
// ── WebGPU / WebLLM flags ─────────────────────────────────
// Enable unsafe WebGPU APIs and the shader-f16 extension required by
// q4f16 MLC models. Electron 34's Chromium gates these behind flags.
app.commandLine.appendSwitch('enable-unsafe-webgpu');
app.commandLine.appendSwitch('enable-features', 'SharedArrayBuffer,WebGPUDeveloperFeatures');
// Allow Dawn (Chromium's WebGPU backend) to expose f16 shader extension
